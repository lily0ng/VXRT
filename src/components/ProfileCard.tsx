...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(180deg, rgba(30, 35, 50, 0.95) 0%, rgba(17, 17, 21, 0.98) 50%, rgba(10, 10, 15, 1) 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  avatarUrl = '/VXRT_Icon_Dark_1080x1080.png',
  iconUrl,
  grainUrl,
  innerGradient,
  behindGlowEnabled = true,
  behindGlowColor = 'rgba(192, 57, 43, 0.5)',
  behindGlowSize = '50%',
  className = '',
  enableTilt = true,
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(192, 57, 43, 0.5)',
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              <img
                className="absolute left-1/2 bottom-0 will-change-transform transition-transform duration-[120ms] ease-out"
                src={avatarUrl}
                ...
                style={{
                  ...
                  transform:
                    'translateX(calc(-50% + (var(--pointer-from-left) - 0.5) * 8px)) translateZ(0) scaleY(calc(1 + (var(--pointer-from-top) - 0.5) * 0.03)) scaleX(calc(1 + (var(--pointer-from-left) - 0.5) * 0.02))',
              ...
              {showUserInfo && (
                <div
                  className="absolute z-[2] flex items-center justify-between backdrop-blur-[16px] border border-white/10 pointer-events-auto"
                  style={
                    {
                      '--ui-inset': '12px',
                      '--ui-radius-bias': '8px',
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="flex flex-col items-start gap-0.5">
                      ...
                      <div className="text-[9px] text-white/50 leading-none flex items-center gap-1">
                  ...
                  <button
                    className="border border-white/10 rounded-lg px-2.5 py-1.5 text-[10px] font-semibold text-white/90 cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-exploit-red/50 hover:bg-exploit-red/10 hover:-translate-y-px"
            ...
            >
              <div className="w-full absolute flex flex-col px-4" style={{ top: '1.5em', display: 'flex', gridArea: 'auto' }}>
                <h3
                  className="font-heading font-bold m-0 tracking-tight text-center"
                  style={{
                ...
                <p
                  className="font-medium text-center mt-1.5 mx-auto"
                  style={{
                ...
                <div className="flex flex-wrap justify-center gap-1.5 mt-2.5">
                  {certs.slice(0, 3).map((cert) => (
                    <span
                      key={cert}
                      className="px-2 py-0.5 bg-exploit-red/20 border border-exploit-red/30 rounded-md text-[9px] font-semibold text-white/90 backdrop-blur-sm"
                    >
                      {cert}
                    </span>
                  ))}
