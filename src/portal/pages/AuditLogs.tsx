  ...
  return (
    ...
    >
      <motion.div variants={itemVariants} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-heading font-bold text-ghost-white">Audit Logs</h1>
          <p className="text-muted-gray mt-1">Security audit trail and activity logs</p>
        </div>
      ...
      <motion.div variants={itemVariants} className="bg-dark-base border border-steel-gray rounded-xl p-12 text-center">
        ...
        <h3 className="text-xl font-semibold text-ghost-white mb-2">No Audit Logs</h3>
        <p className="text-muted-gray max-w-md mx-auto">
          Audit logs will appear here when activity occurs
        </p>
      </motion.div>
    </motion.div>
  );
