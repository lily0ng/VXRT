...
import { Check, ArrowRight, Globe, BadgeCheck } from 'lucide-react';
import { SectionHeading } from '../../components/shared/SectionHeading';
import { services } from '../data/services';

export function WebAppTestingPage() {
  const navigate = useNavigate();
  const service = services['web-app-testing'];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div className="bg-[#111115] border border-border rounded-xl p-8 h-fit">
              <h3 className="text-xl font-heading font-bold text-ghost-white mb-6 flex items-center gap-2">
                <Globe size={20} className="text-exploit-red" />
                Service Metrics
              </h3>
      ...
      <section
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <SectionHeading
            ...
            description="A systematic approach to web application security" />
