...
import { Check, ArrowRight, ClipboardCheck, BadgeCheck } from 'lucide-react';
import { SectionHeading } from '../../components/shared/SectionHeading';
import { services } from '../data/services';

export function SecurityAuditPage() {
  const navigate = useNavigate();
  const service = services['security-audit'];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div className="bg-[#111115] border border-border rounded-xl p-8 h-fit">
              <h3 className="text-xl font-heading font-bold text-ghost-white mb-6 flex items-center gap-2">
                <ClipboardCheck size={20} className="text-exploit-red" />
                Audit Metrics
              </h3>
      ...
      <section
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <SectionHeading
            ...
            description="A systematic approach to security auditing" />
      ...
      <section className="py-24 bg-void-black">
        <div className="container mx-auto px-6 max-w-5xl">
          <SectionHeading
            ...
            description="Comprehensive deliverables for compliance and improvement" />
      ...
      <section className="py-32 bg-dark-base/30 border-t border-border relative overflow-hidden">
        <div className="container mx-auto px-6 relative z-10 text-center max-w-3xl">
          <h2 className="text-4xl md:text-5xl font-heading font-bold text-ghost-white mb-6">
            Ready for a comprehensive audit?
          </h2>
          <p className="text-xl text-muted-text mb-10">
            Schedule a consultation with our audit team to assess your security posture.
          </p>
